...
import { HandThumbUp, StarIcon } from "@heroicons/react/24/solid";
  ...
  return (
    <div className="flex flex-col items-center justify-center px-8 py-4">
      ...
      <div className="relative">
        ...
        />
        <p className="absolute flex flex-col justify-center items-center top-[5%] left-3 text-white">
          <HandThumbUp /> <span>{movieInfo.data.popularity}</span>
        </p>
        <p className="absolute">
          Rating: <span>{movieInfo.datavote_average}</span>
        </p>
      </div>
    </div>
  );
