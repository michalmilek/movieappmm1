      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <ul className="flex mt-5 flex-col items-center gap-4">
          <li className="hover:animate-bounce font-semibold tracking-widest">
            <a href="https://github.com/michalmilek">Github</a>
          </li>
          <li className="hover:animate-bounce select-none font-semibold tracking-widest">
            <a href="https://www.linkedin.com/in/michał-miłek-805011247/">
              LinkedIn
            </a>
          </li>
          <li className="hover:animate-bounce font-semibold tracking-widest">
            <a href="www.michalmilek.pl">My Portfolio</a>
          </li>
          <li className="hover:animate-bounce font-semibold tracking-widest">
            <a href="https://www.facebook.com/michal.m1337/">Facebook</a>
          </li>
          <li className="hover:animate-bounce font-semibold tracking-widest">
            <a href="https://www.instagram.com/michalmilekk/">Instagram</a>
          </li>
        </ul>
      </div>
    </footer>
