...
const ItemDetails = ({ movieInfo }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-1 lg:px-8 py-4">
      ...
      <div className="relative border-white border-[2px] mb-5 mt-5 object-fill lg:h-[700px] lg:w-[800px] h-[400px] w-[400px]">
        <LazyLoadImage
          alt={movieInfo.data.title}
          className="object-fill border-[2px] top-0 left-0 border-white h-[100%]"
          effect="blur"
          src={`${Base_URL}${
